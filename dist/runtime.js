...
var _immutable = _interopRequireDefault(__webpack_require__(2));
...
var defaultPlural = function defaultPlural(n) {
  return n !== 1 ? 1 : 0;
};
...
/*#__PURE__*/
function () {
  function Translations(headers, messages, plural) {
    _classCallCheck(this, Translations);

    this.headers = headers || _immutable.default.Map();
    this.messages = messages || _immutable.default.Map();
...
var GLOBAL = new Translations();

function set_catalog(locale) {
